  ...
  const highlights = [
    {
      ...
      description: "Seu pack e todos os materiais reunidos em um único lugar.",
      animation: "group-hover:rotate-12 group-hover:scale-110"
    },
    {
      icon: "M13 10V3L4 14h7v7l9-11h-7z",
      title: "Acesso Imediato",
      description: "Após a compra, você já entra na área de membros.",
      animation: "group-hover:scale-110 group-hover:-rotate-12"
    },
    {
      icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z",
      title: "Comunidade",
      description: "Conecte-se com outros alunos e evolua junto.",
      animation: "group-hover:scale-110 group-hover:rotate-12"
    },
  ];
          ...
          <div>
            ...
            <div className="flex items-center gap-3 p-4 bg-emerald-500/10 border border-emerald-500/30 rounded-2xl">
              ...
              <p className="text-sm sm:text-base text-gray-300">
                <span className="font-bold text-white">Tudo incluso:</span> pack completo + área de membros + comunidade
              </p>
            </div>
          </div>
