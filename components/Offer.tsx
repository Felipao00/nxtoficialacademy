...
export default function Offer() {
  ...
  const benefits = [
    ...
    { icon: "M12 14l9-5-9-5-9 5 9 5z M12 14l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z", text: "Nativa Academy" },
          ...
          <div className="relative bg-gradient-to-br from-[#0a0f0a] to-[#111] border-2 border-emerald-500/30 rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl shadow-emerald-500/20">
            ...
            <div className="p-5 sm:p-8 lg:p-12">
              <div className="text-center mb-6 sm:mb-8">
                ...
                <div className="mb-6 sm:mb-8">
                  <div className="inline-flex items-center gap-2 sm:gap-3 px-4 sm:px-6 py-2 sm:py-3 bg-emerald-500/10 border border-emerald-500/30 rounded-full">
