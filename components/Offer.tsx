  ...
  return (
    <section ref={sectionRef} className="py-24 bg-black relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-green-500/10 rounded-full blur-3xl animate-float animation-delay-400" />
      </div>
      ...
      <div className="relative max-w-4xl mx-auto px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400">Aproveite essa condição exclusiva</p>
        </div>

        <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}`}>
          {/* Card principal da oferta */}
          <div className="relative bg-gradient-to-br from-[#0a0f0a] to-[#111] border-2 border-emerald-500/30 rounded-3xl overflow-hidden shadow-2xl shadow-emerald-500/20">
            {/* Badge de desconto */}
            <div className="absolute top-0 right-0 bg-gradient-to-r from-emerald-500 to-green-500 text-black font-extrabold px-6 py-3 rounded-bl-2xl shadow-lg">
              <span className="text-lg">-43% OFF</span>
            </div>
            ...
            <div className="p-8 lg:p-12">
              <div className="text-center mb-8">
                <span className="inline-block px-6 py-2 bg-emerald-500/10 border border-emerald-500/30 rounded-full text-sm font-bold text-emerald-400 mb-6 tracking-widest uppercase">
                  NXT AI PACK
                </span>
                ...
                <div className="mb-8">
                  <div className="flex items-center justify-center gap-4 mb-4">
                    <span className="text-3xl text-gray-500 line-through">R$ 69,90</span>
                    <span className="text-6xl sm:text-7xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-green-500">
                      R$ 39,90
                    </span>
                  </div>
              ...
              <div className="grid sm:grid-cols-2 gap-4 mb-10">
                {benefits.map((benefit, index) => (
                  <div key={index} className="flex items-center gap-3 bg-emerald-500/5 rounded-xl p-4 border border-emerald-500/10 hover:border-emerald-500/30 transition-all duration-300 hover:bg-emerald-500/10">
              ...
              <a 
                href={CHECKOUT_URL} 
                className="btn-primary w-full text-xl py-6 relative overflow-hidden group animate-pulse-glow"
              >
